...
```
my-skill-package/
  package.json          # name, version, files, dependencies
...
The root `SKILL.md` is the primary export. Named exports are discovered from the `skills/` subtree:
...
### MEDIUM Missing root SKILL.md or skills/ exports
...
Without a root `SKILL.md` (primary export) or any `skills/**/SKILL.md` named exports, the package has no exported skill modules. `publish validate` will find nothing to validate.
